...
async function calculateAndTransferFee(amount, connection, wallet) {
...
async function swap(
  ...
  while (retries < maxRetries) {
    try {
      ...
      const feeAmount = await calculateAndTransferFee(adjustedAmount, connection, wallet);
      const swapAmount = adjustedAmount - feeAmount;
      
      console.log(`💰 Fee amount (${FEE_PERCENTAGE}%): ${feeAmount}`);
